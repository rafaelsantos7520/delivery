...
import { Heart, Phone, ShoppingCart, Star, ThumbsUp, Zap } from "lucide-react";
import React from "react";

// Este componente recebe outros componentes (Server Components) como children
  ...
  return (
    <div className="bg-gray-50">
      <main>
        ...
        {/* Cardápio - O conteúdo (children) será renderizado aqui */}
        <section id="cardapio" className="py-16 pt-24">
          <div className="container mx-auto px-4">
            ...
            {children} {/* <ProductList/> será inserido aqui */}
          </div>
        </section>
